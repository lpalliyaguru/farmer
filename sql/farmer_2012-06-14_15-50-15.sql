...
LOCK TABLES `fm_area` WRITE;
/*!40000 ALTER TABLE `fm_area` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_area` VALUES ('dfdsf','dsfdsf','23'),('area1','new area','23'),('area3','area3 name','23');
...
INSERT  IGNORE INTO `fm_bank` VALUES ('sfsdfs','sdfsss'),('dss','sdfsfs'),('dssdfd','dfd');
...
LOCK TABLES `fm_bankBranch` WRITE;
/*!40000 ALTER TABLE `fm_bankBranch` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_bankBranch` VALUES ('222','branch 3','sfsdfs'),('1111','branch1','sfsdfs');
...
LOCK TABLES `fm_center` WRITE;
/*!40000 ALTER TABLE `fm_center` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_center` VALUES ('dfs','dfdsf','center3','34');
...
LOCK TABLES `fm_crop` WRITE;
/*!40000 ALTER TABLE `fm_crop` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_crop` VALUES ('1317035970','0001','100','2011-09-26','22.00','4.00','Small','1','123','3460.00'),('1317035986','0001','100','2011-09-26','31.00','4.00','Small','1','124','4960.00'),('1317038131','0001','459','2011-09-26','25.00','4.00','Small','0','125','3880.00'),('1324881848','0001','12356','2011-12-26','30.00','3.00','Small','0','11111','5570.00');
...
LOCK TABLES `fm_cropCategory` WRITE;
...
INSERT  IGNORE INTO `fm_employee` VALUES (11,'manoj','colombo'),(23,'janith','kandy'),(25,'sali','nugegoda');
...
LOCK TABLES `fm_execPerson` WRITE;
/*!40000 ALTER TABLE `fm_execPerson` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_execPerson` VALUES (11,'23'),(25,'55');
...
LOCK TABLES `fm_farmerBelongs` WRITE;
/*!40000 ALTER TABLE `fm_farmerBelongs` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_farmerBelongs` VALUES (1,'12345678','12','01'),(2,'23','3434','343');
...
LOCK TABLES `fm_farmerCost` WRITE;
...
LOCK TABLES `fm_farmerItem` WRITE;
/*!40000 ALTER TABLE `fm_farmerItem` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_farmerItem` VALUES ('122','2','23.00','2012-12-23');
...
LOCK TABLES `fm_item` WRITE;
/*!40000 ALTER TABLE `fm_item` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_item` VALUES ('2333','Item 2','230.00','220.00','kg','erwrewrewrwerw			');
...
LOCK TABLES `fm_previledges` WRITE;
/*!40000 ALTER TABLE `fm_previledges` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_previledges` VALUES (1,'superadmin'),(2,'admin'),(3,'general');
...
LOCK TABLES `fm_season` WRITE;
/*!40000 ALTER TABLE `fm_season` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_season` VALUES (1,'yala 2012','yala season');
...
LOCK TABLES `fm_supPerson` WRITE;
/*!40000 ALTER TABLE `fm_supPerson` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_supPerson` VALUES (23,'34');
...
LOCK TABLES `fm_templates` WRITE;
/*!40000 ALTER TABLE `fm_templates` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_templates` VALUES (1,'default',1),(2,'tulips',0);
...
LOCK TABLES `fm_units` WRITE;
/*!40000 ALTER TABLE `fm_units` DISABLE KEYS */;
INSERT  IGNORE INTO `fm_units` VALUES (1,'Kg'),(2,'g');
...
INSERT  IGNORE INTO `fm_user` VALUES ('admin','superadmin','81dc9bdb52d04dc20036dbd8313ed055','janith','kalhara3','','admin.jpg'),('sali','admin','81dc9bdb52d04dc20036dbd8313ed055','dhanushka','saliya','','sali.gif'),('dfds','superadmin','d9729feb74992cc3482b350163a1a010','sdfs','sdfs','','dfds.');
...
-- Dump completed on 2012-06-14 15:50:15
